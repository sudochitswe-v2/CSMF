...
namespace CSMF.WebMvc.Migrations
{
    ...
    [Migration("20250715195001_AddEligibleCustomerLevelToLoanProduct")]
    partial class AddEligibleCustomerLevelToLoanProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSMF.WebMvc.Domain.Entities.Grantors.Grantor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("CustomerId")
                        .HasDatabaseName("ix_grantors_customer_id");

                    b.ToTable("grantors", (string)null);
                });

            modelBuilder.Entity("CSMF.WebMvc.Domain.Entities.LoanApplicationFees.LoanApplicationFee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_loan_application_fees");

                    b.HasIndex("LoanApplicationId")
                        .HasDatabaseName("ix_loan_application_fees_loan_application_id");

                    b.ToTable("loan_application_fees", (string)null);
                });
            ...
            modelBuilder.Entity("CSMF.WebMvc.Domain.Entities.LoanProducts.LoanProduct", b =>
                {
                    ...
                    b.Property<string>("EligibleCustomerLevels")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("eligible_customer_levels");
            ...
            modelBuilder.Entity("CSMF.WebMvc.Domain.Entities.Grantors.Grantor", b =>
                {
                    b.HasOne("CSMF.WebMvc.Domain.Entities.Customers.Customer", "Customer")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_grantors_customers_customer_id");
            ...
            modelBuilder.Entity("CSMF.WebMvc.Domain.Entities.LoanApplicationFees.LoanApplicationFee", b =>
                {
                    b.HasOne("CSMF.WebMvc.Domain.Entities.LoanApplications.LoanApplication", "LoanApplication")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_loan_application_fees_loan_applications_loan_application_id");
